...
import type { ResetPasswordPayload, TokenPayload } from "../types/jwt.types.js";
...
const generateResetPasswordToken = (payload: ResetPasswordPayload) => {
    ...
    return jwt.sign(
        { payload },
        secret,
        { expiresIn: process.env.RESET_PASSWORD_JWT_EXPIRES_IN || '15m' } as SignOptions
    );
}
